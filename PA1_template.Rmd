...
The mean is **`r data.meanstepsbyday`**. The median is **`r data.medianstepsbyday`**. Please, notice that NA's have been removed before calculating the mean and median.
...
The 5-minute interval where the average across all days reaches the max is : **`r intmax`**. It seems people using such devices like to walk, jog, run 'early' in the morning...
